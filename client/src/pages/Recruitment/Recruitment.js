        ...
        <div className="recruitmentData mt-5">
          <div className="recrumentText">
            <p>
              ...
              recusandae facere.
              <strong>
                teneturadipisci molestias omnis illum maxime rem alias vero
                error suscipit fugit minus voluptates
              </strong>
              <br />
              <br />
          ...
          <div className="row">
            <div className="col-md-6 recruitmentData">
              ...
              <p>
                ...
                laudantium saepe, placeat,
                <strong>
                  voluptates voluptatem commodi veritatis
                </strong> <br /> non esse blanditiis? Incidunt, voluptatum?
                Libero sed sequi alias maiores sit architecto qui corrupti id
                quaerat nemo possimus inventore, amet rerum ex praesentium autem
                illo facilis!
              </p>
            </div>
            <div className="col-md-6 recruitmentData">
              ...
              <p>
                ...
                magni laudantium ,
                <strong>voluptates voluptatem commodi veritatis</strong>
                <br />
